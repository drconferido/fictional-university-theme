...
class Search {
  ...
  keyPressDispatcher(e) {
    if ((e.keyCode === 83 || e.keyCode === 70) && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) {
      this.openOverlay();
    }
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityDataRootUrl.root_url + '/wp-json/ficUniverity/v1/search?term=' + this.searchField.val(), dataResults => {
      this.resultsDiv.html(`
                  <div class="row">
                  <div class="one-third">
