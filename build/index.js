...
class Search {
  ...
  keyPressDispatcher(e) {
    if ((e.keyCode === 83 || e.keyCode === 70) && !this.isOverlayOpen && document.activeElement.tagName !== "INPUT" && document.activeElement.tagName !== "TEXTAREA") {
      this.openOverlay();
    }
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(universityDataRootUrl.root_url + '/wp-json/ficUniverity/v1/search?term=' + this.searchField.value);
